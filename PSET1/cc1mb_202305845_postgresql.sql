...
/*Comandos de criação de tabela e comentários delas*/
--Cria a tabela lojas
CREATE TABLE lojas (
...
--Restrioção da tabela pedidos_itens para o preço não ser negativo
ALTER TABLE pedidos_itens ADD CONSTRAINT preco_positivo2          CHECK(preco_unitario >= 0);

--Restrição da tabela pedidos_itens para a quantidade não ser negativa
